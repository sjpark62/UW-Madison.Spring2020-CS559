...
(function() {
    ...
    var fragmentSource = "" +
        ...
        "varying vec3 outColor;" +
        "void main(void) {" +
        "  vec3 ambient = .001 * vec3(1.0,1.0,1.0);" +
        "  gl_FragColor = vec4(ambient + outColor, 1.0);" +
        "}";
    ...
    var light1 = {
        ...
        // below
        name : "Light at Top of Smaller Skyscraper",
        ...
        draw : function(drawingState) {
            var gl = drawingState.gl;
            var tScale = twgl.m4.scaling([.05,.05,.05]);
            var tTranslation = twgl.m4.translation([4.25,4.75,2.75]);
