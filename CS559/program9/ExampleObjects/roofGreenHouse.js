...
(function() {
    ...
    var vertexColors = [
        .6, .3, 0.0,   .6, .3, 0.0,   .6, .3, 0.0,    // tri 1 = yellow
        .6, .3, 0.0,   .6, .3, 0.0,   .6, .3, 0.0,    // tri 2 = cyan
        .6, .3, 0.0,   .6, .3, 0.0,   .6, .3, 0.0,    // tri 3 = magenta
        .6, .3, 0.0,   .6, .3, 0.0,   .6, .3, 0.0  // tri 4 = green
    ];
    ...
    var roof1 = {
        ...
        draw : function(drawingState) {
            var gl = drawingState.gl;
            var tScale = twgl.m4.scaling([2,1.5,2]);
            var tTranslation = twgl.m4.translation([-3,2,3]);
