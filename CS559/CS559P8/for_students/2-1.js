...
import { RunCanvas } from "../libs/CS559-Libs/runCanvas.js";
import {
  makeCheckbox,
  makeBoxDiv,
  makeFlexDiv,
  ...
  makeSelect,
  LabelSlider
} from "../libs/CS559-Libs/inputHelpers.js";
...
function eulerToy() {
  let toyDiv = document.getElementById("div1");
  ...
  let matchZX = makeCheckbox("lock Z2 to X1", toyDiv);

  let badInterp = makeButton("Bad Interp", toyDiv);
